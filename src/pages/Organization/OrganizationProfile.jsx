...
const OrganizationProfile = () => {
  ...
  const headers = ["License Name", "Band Type", "Maximum User", "Part Number", "Start Date","Expiration Date", "Action"]
  ...
  return (
    <div>
      ...
      <div>
        ...
        <OrgPurchasedLicsTableSheet data={tableData} headers={headers} loading={loading}/>
      </div>
    </div>
  )
}
